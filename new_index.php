	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-lg-8 col-sm-8" id="form1" >
				<form action="php/remote.php" method="post" id="">
					...
					<div class="radio">
						<label class="radio-inline" for="gender">
							<input type="radio" name="genderRadio" value="male" checked="true" />M
						</label>
						<label class="radio-inline" for="gender">
							<input type="radio" name="genderRadio" value="female" />F
						</label>
					</div>
					<div class="form-group">
					...
					<input type="checkbox" class="move"> <p class="move move2">Accetto l'informativa.</p>
					<br>
